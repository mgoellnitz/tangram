...
public class ModelAwareInternalResourceViewResolver extends
		AbstractModelAwareViewResolver implements InitializingBean,
		ServletContextAware {
	...
	private static Log log = LogFactory
			.getLog(ModelAwareInternalResourceViewResolver.class);
	...
	@Override
	protected String getFullViewName(String view, String packageName,
			String simpleName) {
		return packageName + "/" + simpleName
				+ (Constants.DEFAULT_VIEW.equals(view) ? "" : "." + view);
	} // getFullViewName()
	...
	public void afterPropertiesSet() throws Exception {
		...
		Assert.notNull(filePathPrefix,
				"path to lookup templates may not be null");
