...
<div class="tangram_footer">
  Tangram Object Presenter <span class="longversion"><%=org.tangram.Constants.VERSION%><c:catch><c:if test="${! empty implementation}"> (${implementation})</c:if></c:catch> </span>| &copy; 2010-2015
