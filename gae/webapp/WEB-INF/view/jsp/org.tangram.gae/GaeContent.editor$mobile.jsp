...
<br/>with <%=com.google.appengine.api.utils.SystemProperty.version.get()%> and<br/>tangram <%=Constants.getVersion() %> JDO <%=TangramJDO.getVersion() %> GAE <%=TangramGAE.getVersion() %> 
