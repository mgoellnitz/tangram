...
%><%@page import="org.tangram.gae.protection.PasswordProtection"
...
<div style="padding: 10px;">
<label >Login: </label><input type="text" name="<%=PasswordProtection.PARAM_LOGIN %>"/>
</div>
<div style="padding: 10px;">
<label>Password: </label><input type="password" name="<%=PasswordProtection.PARAM_PASSWORD%>" />
</div>
<div style="padding: 10px;">
