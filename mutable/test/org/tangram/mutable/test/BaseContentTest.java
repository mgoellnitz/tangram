...
public abstract class BaseContentTest<M extends Object, Q extends Object> {
    ...
    public void test08ObtainCode() throws Exception {
        ...
        Assert.assertEquals(classBytes.length, 2613, "Unexpected number of bytes for class found.");
        ...
        Assert.assertEquals(emptyClassBytes.length, 2613, "Unexpected number of bytes for class found.");
