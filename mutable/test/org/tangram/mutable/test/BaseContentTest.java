...
public abstract class BaseContentTest<M extends Object, Q extends Object> {
    ...
    protected MutableBeanFactory<M, Q> getMutableBeanFactory() throws Exception {
        return SystemUtils.convert(getInstance(MutableBeanFactory.class));
    ...
    public void test08ObtainCode() throws Exception {
        ...
        Assert.assertEquals(classBytes.length, 2583, "Unexpected number of bytes for class found.");
        ...
        Assert.assertEquals(emptyClassBytes.length, 2583, "Unexpected number of bytes for class found.");
